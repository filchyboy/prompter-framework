...
const templatesPath = path.join(__dirname, '../templates/templates.js');
const taskTypesPath = path.join(__dirname, '../templates/taskTypes.js');

// Dynamic imports for ES modules
let templates, taskTypes;

export const initializeData = async () => {
  const templatesModule = await import('../templates/templates.js');
  const taskTypesModule = await import('../templates/taskTypes.js');
